...
def test_hex_to_curses_basic():
    # Test valid hex
    assert hex_to_curses_basic("#000000") == curses.COLOR_BLACK
    assert hex_to_curses_basic("#ffffff") == curses.COLOR_WHITE
    assert hex_to_curses_basic("#ff0000") == curses.COLOR_RED
    assert hex_to_curses_basic("default") == -1

    # Test invalid hex formats fallback to white (7)
    assert hex_to_curses_basic("invalid") == curses.COLOR_WHITE
    assert hex_to_curses_basic("#123") == curses.COLOR_WHITE
